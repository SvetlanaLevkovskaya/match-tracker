...
export const PlayerCard = ({ player }: PlayerProps) => (
  <div className="bg-gray-3 flex-center-center xl:flex-center-between rounded px-6 py-2 min-w-[123px] max-w-[290px] flex-1 flex-col xl:flex-row gap-1">
    <div className="flex-center-center gap-[5.5px] tb:gap-2 flex-nowrap">
      ...
      />
      <span className="w-[80px] truncate text-ellipsis overflow-hidden whitespace-nowrap text-s_text tb:text-s_body text-left">
        {player.username}
      </span>
    </div>
